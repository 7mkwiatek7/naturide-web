...
export const ui = {
  pl: {
    ...
    'hero.badge': 'Testy wewnętrzne',
    'hero.title': 'Naturide',
    'hero.subtitle': 'Mapy - planer tras - nawigacja',
    'hero.description':
      'Naturide to inteligentna nawigacja, mapy i planer tras dla miłośników turystyki pieszej i rowerowej. Posiada wiele ciekawych funkcji takich jak automatyczne zarządzanie ekranem czy adaptacyjny zapis śladu. Planuj trasy i nawiguj offline. Ciesz się prywatnością. ',
    ...
    'features.subtitle': 'Funkcje, które przydadzą się na każdej wycieczce',
    'features.navigation.title': 'Nawigacja Offline',
    'features.navigation.desc':
      'Prowadzenie po trasie, również z pliku GPX. Po zjeździe z trasy algorytm szybko tworzy łącznik, by użytkownik mógł sprawnie wrócić na trasę nawet gdy nie ma internetu',
    ...
    'comingsoon.benefit2.desc': 'Twoje uwagi pomogą nam ją ulepszyć.',
    'comingsoon.benefit3.title': 'Kontakt bez spamu',
    'comingsoon.benefit3.desc': 'Napiszemy tylko w sprawie testów.',
    'comingsoon.placeholder': 'Twój adres email',
    'comingsoon.submit': 'Dołącz do testów',
    'comingsoon.loading': 'Wysyłanie...',
    'comingsoon.honeypot': 'Nie wypełniaj tego pola:',
    'comingsoon.privacy': 'Bez spamu — tylko informacje dotyczące testów.',
    'comingsoon.consent':
      'Wyrażam zgodę na przetwarzanie mojego adresu email w celu kontaktu w sprawie testów wewnętrznych zgodnie z',
    'comingsoon.privacyPolicy': 'polityką prywatności',
    'comingsoon.success': 'Gotowe! Odezwiemy się ze szczegółami testów Naturide.',
    'comingsoon.error': 'Ups, coś poszło nie tak. Spróbuj ponownie za chwilę.',
    'comingsoon.mailSent': 'Zgłoszenie zostało przekazane do zespołu.',
    ...
    'remove.subtitle':
      'Jeśli chcesz wycofać zgodę i usunąć swój adres email z listy osób zainteresowanych testami, wypełnij formularz poniżej.',
    'remove.label.email': 'Twój adres email',
    'remove.submit': 'Usuń moje dane',
    'remove.confirm':
      'Potwierdzam, że chcę usunąć swój adres email z listy osób zainteresowanych testami zgodnie z',
    'remove.privacy':
      'Twój email zostanie usunięty z naszej listy w ciągu 7 dni roboczych.',
    'remove.success': 'Gotowe! Twój adres email został usunięty z naszej listy osób zainteresowanych testami.',
  ...
  en: {
    ...
    'hero.cta.notify': 'Discover Naturide',
    ...
    'features.layers.desc': '—',
    'screens.title': 'The best rides begin where\nfamiliar paths end',
    ...
    'comingsoon.eyebrow': 'Join the internal test',
    'comingsoon.title': 'Join the Naturide explorers',
    'comingsoon.desc':
      'We are looking for people who want to try Naturide on real rides and share their feedback. Leave your email and we will send you the details.',
    'comingsoon.benefit1.title': 'Test version',
    'comingsoon.benefit1.desc': 'Try the app before the public launch.',
    'comingsoon.benefit2.title': 'Shape the product',
    'comingsoon.benefit2.desc': 'Your feedback will help us improve it.',
    'comingsoon.benefit3.title': 'No spam',
    'comingsoon.benefit3.desc': 'We will only contact you about testing.',
    'comingsoon.placeholder': 'Your email address',
    'comingsoon.submit': 'Join the test',
    'comingsoon.loading': 'Sending...',
    'comingsoon.honeypot': 'Do not fill in this field:',
    'comingsoon.privacy': 'No spam — only testing updates.',
    'comingsoon.consent':
      'I agree to the processing of my email address so you can contact me about internal testing, according to the',
    'comingsoon.privacyPolicy': 'privacy policy',
    'comingsoon.success': 'Done! We will contact you with details about Naturide testing.',
    'comingsoon.error': 'Oops, something went wrong. Please try again in a moment.',
    'comingsoon.mailSent': 'Your application has been sent to the team.',
    'comingsoon.mailNotSent':
    ...
    'remove.subtitle':
      'If you want to withdraw your consent and remove your email from the internal testing list, fill in the form below.',
    'remove.label.email': 'Your email address',
    'remove.submit': 'Remove my data',
    'remove.confirm':
      'I confirm that I want to remove my email address from the internal testing list according to the',
    'remove.privacy':
      'Your email will be removed from our list within 7 business days.',
    'remove.success': 'Done! Your email address has been removed from our internal testing list.',
